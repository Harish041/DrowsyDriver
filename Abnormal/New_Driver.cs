...
namespace Abnormal
{
    public partial class New_Driver : Form
    {
        ...
        string userName;
        String TrackerMemoryFile = "D:\\tracker.dat";
        int mouseX = 0;
        int mouseY = 0;
        ...
        {
            if (FSDK.FSDKE_OK != FSDK.ActivateLibrary("GTEvrl+eSxjqfo8LMD+otecqyYJe8YSvxOi/VgkjZGJmKSNJjk/x8DCN9q0elq+WWqpDbCWZvwe5uDFtdYdr5J5FvnkU6QQE+htZJGFqFpIj320JnuZ4henPCtOS8ejKTIVfkW0uP0GzyqYjfuw9YljKKVYsMkjbqPvkSW1TOCY="))
            {
                        ...
                        if (ProgramState.psRemember == programState)
                        {
                            if (FSDK.FSDKE_OK == FSDK.LockID(tracker, IDs[i]))
                            {
                               ...
                               // InputName inputName = new InputName();
                                NewDriverReg inputName = new NewDriverReg();
